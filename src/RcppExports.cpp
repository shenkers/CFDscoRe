...
RcppExport SEXP _CFDscoRe_private_optimal_alignment(SEXP activity_scoresSEXP, SEXP querySEXP, SEXP genomeSEXP, SEXP max_edit_distanceSEXP, SEXP max_bulgeSEXP, SEXP max_mismatchSEXP, SEXP allow_bulgeSEXP, SEXP search_both_strandsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type activity_scores(activity_scoresSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type max_mismatch(max_mismatchSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(private_optimal_alignment(activity_scores, query, genome, max_edit_distance, max_bulge, max_mismatch, allow_bulge, search_both_strands));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CFDscoRe_private_optimal_alignment", (DL_FUNC) &_CFDscoRe_private_optimal_alignment, 8},
    {NULL, NULL, 0}
};
