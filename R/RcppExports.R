...
private_optimal_alignment <- function(activity_scores, query, genome, max_edit_distance, max_bulge, allow_bulge, search_both_strands) {
    .Call(`_CFDscoRe_private_optimal_alignment`, activity_scores, query, genome, max_edit_distance, max_bulge, allow_bulge, search_both_strands)
}
