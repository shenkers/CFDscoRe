...
private_cfd_score <- function(activity_scores, guide, genome, pam, strict) {
    .Call(`_CFDscoRe_private_cfd_score`, activity_scores, guide, genome, pam, strict)
}
...
private_optimal_alignment <- function(activity_scores, query, genome, max_edit_distance, max_bulge, max_mismatch, allow_bulge, search_both_strands) {
    .Call(`_CFDscoRe_private_optimal_alignment`, activity_scores, query, genome, max_edit_distance, max_bulge, max_mismatch, allow_bulge, search_both_strands)
}
